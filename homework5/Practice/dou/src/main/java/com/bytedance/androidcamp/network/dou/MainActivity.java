...
public class MainActivity extends AppCompatActivity {
    ...
    private void postVideo() {
        ...
        miniDouyinService.postvideo("8848", "nibaba", coverImagePart, videoPart).enqueue(
                new Callback<ResponePost>() {
                    @Override
                    public void onResponse(Call<ResponePost> call, Response<ResponePost> response) {
                        ...
                        mBtn.setText("select an imagine");
                        mBtn.setEnabled(true);
                    }

                    @Override
                    public void onFailure(Call<ResponePost> call, Throwable throwable) {
                        mBtn.setText("select an imagine");
                        mBtn.setEnabled(true);
    ...
    public void fetchFeed(View view) {
        ...
        miniDouyinService.getvideos().enqueue(new Callback<ResponseGet>() {
            @Override
            ...
            @Override
            public void onFailure(Call<ResponseGet> call, Throwable throwable) {
