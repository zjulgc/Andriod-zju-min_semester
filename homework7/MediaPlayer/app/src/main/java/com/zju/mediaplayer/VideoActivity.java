...
import com.zju.mediaplayer.Video.VideoPlayerIJK;
import com.zju.mediaplayer.Video.VideoPlayerListener;
...
public class VideoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    VolumnReciever reciever = new VolumnReciever();
    ...
    private void init() {
        ...
        VoiceBar = findViewById(R.id.sb_2);
        ...
        VoiceBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            @Override
            public void onStartTrackingTouch(SeekBar seekBar) {
                Toast.makeText(VideoActivity.this, "Volume is " + VoiceBar.getProgress(), Toast.LENGTH_SHORT).show();
            }
    ...
    private class VolumnReciever extends BroadcastReceiver
    {
        @Override
